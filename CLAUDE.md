...
- **BAR RIVAL = "SCRIPT KIDDIES"** (placa: "Hackers de tutorial") — devs novatos que se acham hackers/sênior mas só rodam script pronto. Letreiros da rua corrigidos com texto TMP por cima da arte (`Facade_*/NeonFix`).
